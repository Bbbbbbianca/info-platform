  ...
  <view class="tf-join-container">
    ...
    <view class="tf-join-select-part">
      <view class="tf-join-select-options">
        <view class="tf-join-select-option">
          <view class="tf-join-select-option-text">
            时间
          </view>
          <view
            v-if="!showSelectedDate"
            class="tf-join-select-option-icon"
      ...
      <AtCalendar
        ...
        class="tf-join-select-calender"
      />

      <view
        v-if="showSelectedTags"
        class="tf-join-select-scope"
      >
        <view
          v-for="tag in tags"
          class="tf-join-select-scope-item"
        >
          <AtTag
            :name="tag.name"
            circle
    ...
    <view class="tf-join-list">
      <view
        ...
        class="tf-join-list-item"
      >
        <image
          :src="activity.coverUrl"
          mode="scaleToFill"
          class="tf-join-list-item-image"
        />
        <view
          class="tf-join-list-item-icon-part"
          @tap="onViewDetail(activity)"
        >
          <AtIcon
            value="chevron-right"
            size="32"
            class="tf-join-list-item-icon"
          />
        </view>
      </view>
    </view>
