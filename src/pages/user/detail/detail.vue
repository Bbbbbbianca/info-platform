  ...
  <view class="tf-detail-container">
    <view class="tf-detail-main-part">
      ...
      <view class="tf-detail-btn-part">
        <AtButton
          v-if="activity.isSignUp() && !activity.join && !activity.isFull() "
          type="primary"
          :on-click="onJoinActivity"
          class="tf-detail-btn"
        >
          报名
        </AtButton>
        ...
        <AtButton
          v-if="activity.isSignUp() && activity.join"
          :on-click="onUnJoinActivity"
          class="tf-detail-info-btn"
        >
          取消报名
        </AtButton>
        <AtButton
          v-if="activity.isSignUpEnd()"
          type="primary"
          :on-click="onJoinActivity"
          class="tf-detail-btn"
          disabled
    ...
    <view
      v-if="joinSuccessHint || unJoinSuccessHint || joinFailureHint"
      class="tf-detail-mask"
    />
    <view
      v-if="joinSuccessHint"
    ...
    >
      <view class="tf-detail-dialog-card">
        <view class="tf-detail-dialog-content">
          ...
          <view class="tf-detail-dialog-content-hint">
            届时请准时到场参加，违规三次以上将会被限制报名！
          </view>
        </view>

        <view class="tf-detail-dialog-action">
          <view
            class="tf-detail-dialog-action-text"
            @tap="confirmJoinSuccess"
          >
            确认
          </view>
        </view>
