  ...
  <view class="tf-register-container">
    ...
    <view class="tf-register-main-part">
      <view class="tf-register-card">
        <view class="tf-register-card-title-text">
          注册
        </view>
        <view class="tf-register-card-title-tab" />
        ...
        >
          <AtButton
            v-if="remainedTime<=0"
            size="small"
            class="tf-register-code-button"
            :on-click="sentVerificationCode"
          >
            发送验证码
          </AtButton>
          <view
            v-else
            class="tf-register-code-text"
          >
            {{ remainedTime }}s后重发
          </view>
        </AtInput>
    ...
    >
      <AtActionSheetItem class="tf-register-action-first-item">
        <AtAvatar
          ...
          class="tf-register-action-avatar"
        />
      ...
      <AtActionSheetItem>
        <AtButton
          ...
          :on-get-user-info="bindGetUserInfo"
          style="border: none;"
        >
          微信授权
        </AtButton>
